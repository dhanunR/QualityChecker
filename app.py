...
with st.form(key="new_form"):
    ...
    selectedcolumn = st.selectbox('Select the First Column',options=read_data1.column)
    selectedcolumn2 = st.selectbox('Select the Second Column',options=read_data1.column)
